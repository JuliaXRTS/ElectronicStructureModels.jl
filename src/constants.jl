...
const BOHR_RADIUS_METER = BOHR_RADIUS_ANG * 1.0e-10 # Meter
const BOHR_RADIUS_INV_EV = BOHR_RADIUS_ANG / HBARC_eV_ANG   # ≈ 2.6818e-4 eV⁻¹
const BOHR_RADIUS_INV_ME = BOHR_RADIUS_INV_EV * ELECTRONMASS # ≈ 2.6818e-4 eV⁻¹
